...
--
-- DATABASE NAME: settle-production
-- INSTRUCTIONS:
--   1. Create new Supabase project named "settle-production"
--   2. Open SQL Editor in Supabase dashboard
--   3. Copy and paste this entire file
--   4. Click "Run"
--   5. Verify success message at the end
--
...
BEGIN
    ...
    RAISE NOTICE '  2. Test connection: python scripts/test_supabase_connection.py';
    RAISE NOTICE '  3. Start SETTLE service: uvicorn app.main:app --reload --port 8002';
    RAISE NOTICE '  4. Visit API docs: http://localhost:8002/docs';
    RAISE NOTICE '============================================================================';
END $$;
